...
def app():
    ...
    # file uploader
    uploaded_file = st.file_uploader(label='Please upload your CV', type=['docx'])
    ...
    if doc != '':
        ...
        fig = go.Figure(data=[go.Table(
            header=dict(values=list(recommender_summary.columns),
                        fill_color='paleturquoise',
                        align='left'),
            cells=dict(values=[recommender_summary.job_title, 
